<template>
    <div>
        <b-modal id="delete-recipe-modal" hide-footer hide-header centered>
            ...
            <div>
                <button class="mt-3 mr-2 btn btn-link" @click="$bvModal.hide('delete-recipe-modal')">No</button>
                <button class="mt-3 btn btn-link text-danger" @click="deleteRecipe">Yes</button>
            </div>
        </b-modal>
    </div>
</template>
